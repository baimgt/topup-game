...
export const defaultDuitkuMethods: PaymentMethod[] = [
  ...
  // Transfer Bank (Virtual Account Resmi Duitku)
  ...
  { id: "B1", name: "CIMB Niaga Virtual Account", group: "Transfer Bank", enabled: true, fee: 4000, feeType: "flat" },
  { id: "BT", name: "Permata Bank Virtual Account", group: "Transfer Bank", enabled: true, fee: 4000, feeType: "flat" },
  { id: "BV", name: "BSI Virtual Account", group: "Transfer Bank", enabled: true, fee: 4000, feeType: "flat" },
  { id: "VA", name: "Maybank Virtual Account", group: "Transfer Bank", enabled: true, fee: 4000, feeType: "flat" },
  { id: "AG", name: "Bank Artha Graha Virtual Account", group: "Transfer Bank", enabled: true, fee: 4000, feeType: "flat" },
  { id: "NC", name: "Bank Neo Commerce Virtual Account", group: "Transfer Bank", enabled: true, fee: 4000, feeType: "flat" },
  { id: "S1", name: "Bank Sahabat Sampoerna Virtual Account", group: "Transfer Bank", enabled: true, fee: 4000, feeType: "flat" },
  { id: "A1", name: "ATM Bersama", group: "Transfer Bank", enabled: true, fee: 4000, feeType: "flat" },
  // Retail / Minimarket
